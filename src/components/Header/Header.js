      ...
      <Container fluid>
        ...
        <Navbar.Collapse id='responsive-navbar-nav' className='nav-container'>
          <Nav variant='tabs' fill activeKey={activeKey} onSelect={handleChange} className='nav' bg='dark' variant='dark'>
            <Nav.Item>
              <Nav.Link eventKey='' variant='dark' id="go-home">Home</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey='find-vet' id="find-a-vet">Find a Vet</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey='suggestion' id="make-suggestion">Make a Suggestion</Nav.Link>
            </Nav.Item>
          </Nav>
        </Navbar.Collapse>
      </Container>
